 ...
 */
class getMethodePaiementRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MethodePaiementRepository.php';

        return $container->privates['App\\Repository\\MethodePaiementRepository'] = new \App\Repository\MethodePaiementRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
