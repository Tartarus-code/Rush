 ...
 */
class getParticiperRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParticiperRepository.php';

        return $container->privates['App\\Repository\\ParticiperRepository'] = new \App\Repository\ParticiperRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
