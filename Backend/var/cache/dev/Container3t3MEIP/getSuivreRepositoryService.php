 ...
 */
class getSuivreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SuivreRepository' shared autowired service.
     *
     * @return \App\Repository\SuivreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SuivreRepository.php';

        return $container->privates['App\\Repository\\SuivreRepository'] = new \App\Repository\SuivreRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
