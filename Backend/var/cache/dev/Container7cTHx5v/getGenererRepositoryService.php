 ...
 */
class getGenererRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GenererRepository' shared autowired service.
     *
     * @return \App\Repository\GenererRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GenererRepository.php';

        return $container->privates['App\\Repository\\GenererRepository'] = new \App\Repository\GenererRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
