 ...
 */
class getRecevoirRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RecevoirRepository' shared autowired service.
     *
     * @return \App\Repository\RecevoirRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RecevoirRepository.php';

        return $container->privates['App\\Repository\\RecevoirRepository'] = new \App\Repository\RecevoirRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
