 ...
 */
class getSouscriptionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SouscriptionRepository' shared autowired service.
     *
     * @return \App\Repository\SouscriptionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SouscriptionRepository.php';

        return $container->privates['App\\Repository\\SouscriptionRepository'] = new \App\Repository\SouscriptionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
