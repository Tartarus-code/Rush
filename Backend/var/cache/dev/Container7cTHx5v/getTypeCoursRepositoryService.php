 ...
 */
class getTypeCoursRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeCoursRepository.php';

        return $container->privates['App\\Repository\\TypeCoursRepository'] = new \App\Repository\TypeCoursRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
