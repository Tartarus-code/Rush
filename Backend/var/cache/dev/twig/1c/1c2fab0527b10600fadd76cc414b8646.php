...
class __TwigTemplate_8e08a5b01e736db7133562577a863518 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <div class=\"h1\">Créer un nouveau Status</div>
...
{% block title %}Status Form{% endblock %}

{% block body %}
    <div class=\"h1\">Créer un nouveau Status</div>

    {{ form_start(form) }}
        {{ form_widget(form) }}
    {{ form_end(form) }}
{% endblock %}
", "status/index.html.twig", "C:\\Dev\\laragon\\www\\Rush\\Backend\\templates\\status\\index.html.twig");
    }
}
